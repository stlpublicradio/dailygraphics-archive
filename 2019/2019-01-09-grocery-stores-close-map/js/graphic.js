...
function render(width) {
	...
	var northEast = L.latLng(38.726562,-90.303477),
			southWest = L.latLng(38.820635,-90.156614),
			...
			d3.json("stores.topojson", function (error, geodata) {
				...
				legend.onAdd = function (map) {
					...
					// Legend with strings
					div.innerHTML = '<img height="10px" src="https://raw.githubusercontent.com/pointhi/leaflet-color-markers/master/img/marker-icon-green.png"> Schnucks <br> <img height="10px" src="https://raw.githubusercontent.com/pointhi/leaflet-color-markers/master/img/marker-icon-red.png"> Closed Shop &#39;n Saves';
			...
			d3.json("schnucks.topojson", function (error, geodata) {
				...
				geojson = L.geoJson(regions, {
					...
					pointToLayer: function (feature, latLng) {
							...
							marker.bindPopup('<strong>' + feature.properties.ref + '</strong><br>' + feature.properties.addr + ' ' + feature.properties.city  + ', ' + feature.properties.state + ' ' + feature.properties.postal)
							return marker
					}
				})
