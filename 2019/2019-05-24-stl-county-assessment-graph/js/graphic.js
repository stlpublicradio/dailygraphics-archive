...
var renderSlopegraph = function(config) {
    ...
    var changeLabel = config['labels']['change_label'];
    ...
    var colorScale = d3.scale.ordinal()
        ...
        .range([ '#901729', '#B81D35', '#D1364F', '#DB6277', '#E0788B', '#E58E9F', '#EAA4B3', '#EFBAC7', '#F4D0DB','#F9E6EF' ]);
    ...
    chartElement.append('g')
        ...
        .append('text')
            ...
            .text(function(d) {
                return d[labelColumn] + ': ' +  fmtMoney(d[startColumn]);
            })
            .call(wrapText, (margins['left']), 12);
    ...
    chartElement.append('g')
        ...
        .append('text')
            ...
            .text(function(d) {
                return fmtMoney(d[endColumn]) + ' (' + d[changeColumn].toFixed(1) + '%)';
            });
