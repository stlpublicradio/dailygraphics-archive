...
function render(width) {
	    ...
	    var svg = d3.select(map.getPanes().overlayPane).append("svg"),
			...
			// update filename, collection name
			 ...
			 d3.json("counties.topojson", function(error, geodata) {
			 ...
			 return d < 10 ? colors.yellow :
				 ...
				 function style(feature) {
						 return {
							 // update property
					         fillColor: getColor(feature.properties.insecurity_rate),
					         weight: 1,
					         opacity: 1,
					         color: colors.yellow,
					         dashArray: '3',
				 ...
				 info.update = function (props) {
				     this._div.innerHTML = '<h4>Food Insecurity</h4>' 
					 ...
					 +  (
						 ...
						 : "In <strong>" + props.NAME + "</strong>, <strong>" + props.insecurity_rate + '%</strong> of residents are food insecure.'
						 : 'Hover over a county');
				 };
