...
function render(width) {
	    ...
	    var svg = d3.select(map.getPanes().overlayPane).append("svg"),
	        g = svg.append("g").attr("class", "leaflet-zoom-hide");
			 ...
			 d3.json("stlco_municipalities_traffic.json", function(error, us) {
				 
				 var counties = topojson.feature(us, us.objects.stlco_municipalities);
				 var geojson;
				 ...
				 info.update = function (props) {
				     this._div.innerHTML = '<h4>Mack\'s Creek Law</h4>The law says municipal fines and court costs can make up no more than 30% of a city\'s revenue. Thursday, Attorney General Chris Koster announced he added four St. Louis municipalities to a suit alleging they failed to comply with the law. Koster also announced six cities were dropped from the suit.<br><br>' +  (
						 props ? 
						 props.STATUS == 'new' ? 
