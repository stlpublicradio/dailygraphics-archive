...
var colors = { 'green': '#449970', 'ltgreen': '#A2CCB8', 'blue': '#358fb3', 'ltblue': '#9AC7D9', 'orange': '#f6883e', 'ltorange': '#FBC49F', 'red': '#cc203b', 'ltred': '#E6909D', 'maroon': '#8c1b52', 'ltmaroon': '#C68DA9', 'black': '#333333', 'gray': '#aaaaaa'}
...
var renderSlopegraph = function(config) {
    ...
    var colorScale = d3.scale.ordinal()
        ...
        .range([ colors['ltgreen'], colors['green'], colors['ltblue'], colors['blue'], colors['ltorange'], colors['orange'], colors['ltred'], colors['red'], colors['ltmaroon'], colors['maroon'], colors['gray'], colors['black'] ]);
    ...
    chartElement.append('g')
        ...
        .append('text')
            ...
            .attr('dx', 6)
            .attr('dy', function(d) {
                return (d[labelColumn] == 'St. Louis 60-79' ? 20 :
                d[labelColumn] == 'St. Louis 20-39' ? 10 :
                d[labelColumn] == 'St. Louis all ages' ? -2 :
                3);
            })
            .attr('class', function(d) {
                return classify(d[labelColumn]);
