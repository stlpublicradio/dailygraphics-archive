			...
			// update filename, collection name
			 ...
			 d3.json("wards.topojson", function(error, geodata) {
                 ...
                 function getOpacity(d) {
                      ...
                      op = Math.abs(d.yes - d.no) / (d.yes + d.no)
				 ...
				 info.update = function (props) {
                     ...
                     this._div.innerHTML = '<h2>Support for Prop 2</h2>Overall, Prop 2 lost by 3,240 votes.<br><br>'

					 // example ternary logic for infobox
					 +  (
						 props ?
                         (props.yes > props.no) ? "<strong>Ward " + props.WARD10 + "</strong> voted <strong>in support of</strong> Prop 2.<br/>Yes: " + fmtThousands(props.yes) + " (" + fmtPct(props.yes / (props.yes + props.no)) + ")<br/>No: " + fmtThousands(props.no) + " (" + fmtPct(props.no / (props.yes + props.no)) + ")" : "<strong>Ward " + props.WARD10 + "</strong> voted <strong>against</strong> Prop 2.<br/>Yes: " + fmtThousands(props.yes) + " (" + fmtPct(props.yes / (props.yes + props.no)) + ")<br/>No: " + fmtThousands(props.no) + " (" + fmtPct(props.no / (props.yes + props.no)) + ")"
						 : 'Hover over a ward');
				 };
