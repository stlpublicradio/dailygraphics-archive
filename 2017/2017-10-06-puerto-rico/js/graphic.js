...
var COUNTRY_LABEL_ADJUSTMENTS = {
    'Haiti': { 'text-anchor': 'end', 'dy': 7, 'dx': -10 },
    'Dominican Rep.': { 'dy': -5, 'dx': 40 },
    'Puerto Rico': { 'dy': 15, 'dx': -5}
}
...
var renderLocatorMap = function(config) {
    ...
    d3.select('.scale-bar')
         ...
         * Remove labels.
         */
         removals = ['.mexico','.turks-and-caicos-is','.usnb-guantanamo-bay','.cayman-is','.us-minor-outlying-is','.british-virgin-is','.us-virgin-is','.santo-domingo','.label.united-states','.honduras','.anguilla','.st-kitts-and-nevis','.st-martin','.netherlands','.sint-maarten','.st-barthlemy']
