...
function render(width) {
		...
		var map = L.map('map', {scrollWheelZoom: false, attribution: ''}).setView([38.637344, -90.231072], 12).setMaxBounds(bounds);
	    ...
	    var svg = d3.select(map.getPanes().overlayPane).append("svg"),
			...
			// update filename, collection name
			 ...
			 d3.json("payday_stl.topojson", function(error, geodata) {
