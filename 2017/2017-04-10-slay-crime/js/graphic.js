...
var renderLineChart = function(config) {
    ...
    var colorScale = d3.scale.ordinal()
        ...
        .range([colors.orange, colors.yellow]);
    ...
    chartElement.append('g')
        ...
        .attr('transform', function() { return 'translate(' + (xScale(2013) + 16) + ',' + yScale(max) + ')rotate(-90)';})
        ...
        .attr('transform', function() { return 'translate(' + (xScale(2001) + 16) + ',' + yScale(10000) + ')rotate(-90)';})
        .call(wrapText, (chartHeight / 2), 14)
