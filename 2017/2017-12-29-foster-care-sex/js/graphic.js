...
var render = function(containerWidth) {
    ...
    renderGroupedBarChart({
        container: '#grouped-bar-chart-sex',
        width: containerWidth,
        data: DATA_SEX,
        color_ramp: [colors.red,colors.blue]
    });
...
var renderBarChart = function(config) {
    ...
    var xAxis = d3.svg.axis()
        ...
        .ticks(ticksX)
        .tickFormat(function(d) {
            return fmtThousands(d.toFixed(0));
        });
    ...
    chartElement.append('g')
        ...
        .append('text')
            .text(function(d) {
                if (config['text']) {
                    return fmtThousands(d[valueColumn].toFixed(0)) + ' ' + config['text']; 
                }
                else {
                    return fmtThousands(d[valueColumn].toFixed(0));
                }
            })
            .attr('x', function(d) {
                return xScale(d[valueColumn]);
