...
var renderDotChart = function(config) {
    ...
    var sortOrder = ["Statewide General", "Presidential Primary", "Statewide Primary", "Municipal General", "Municipal Primary"]
    ...
    var chartHeight = ((barHeight + barGap) * getMaxTypes(nested)) + 500;
       ...
       */
       ...
       var createPopup = function(d) {
           div.transition()
                .duration(200)
                .style("opacity", .9);
            div.html(d.year + " " + d.type + "<br/>"  + d.place + ": <strong>" + d.turnout + "%</strong>")
