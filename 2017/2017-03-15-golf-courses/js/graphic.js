...
function render(width) {
		...
		var map = L.map('map', {scrollWheelZoom: false, attribution: ''}).setView([38.697751, -90.300622], 12).setMaxBounds(bounds);
        ...
        var norwood = L.marker([38.722428, -90.282801]).bindPopup("<b>Norwood Country Club</b>").addTo(map);
        var glen_echo = L.marker([38.699358, -90.300364]).bindPopup("<b>Glen Echo Country Club</b>").addTo(map);
        var normandie = L.marker([38.697760, -90.317037]).bindPopup("<b>Normandie Golf Club</b>").addTo(map);
