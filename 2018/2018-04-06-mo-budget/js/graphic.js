...
var formatData = function() {
    ...
    DATA_REVENUE.forEach(function(d) {
        var x0 = 0;
...
var render = function(containerWidth) {
    ...
    renderStackedBarChart({
        ...
        data: DATA,
        color_scale: [ colors.orange,colors.blue,colors.yellow,colors.red,colors.purple,colors.brown ]
    });

    renderStackedBarChart({
        container: '#stacked-bar-chart-revenue',
        width: containerWidth,
        data: DATA_REVENUE,
        color_scale: [ colors.dkgreen, colors.green, colors.ltgreen, colors.tan ]
    });
