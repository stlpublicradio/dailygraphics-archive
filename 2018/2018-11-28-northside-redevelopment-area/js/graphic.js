...
// /*
    ...
    chartElement.append('g')
        .attr('class', 'streets')
        .selectAll('path')
            .data(mapData['streets']['features'])
        .enter().append('path')
            .attr('d', path)
            .attr('id', function(d) { return classify(d['id'])});            
    ...
    chartElement.append('g')
            ...
            .enter().append('text')
                ...
                .attr('transform', function(d) {
                    if (d['slug'] == 'cass') {
                        return 'translate(' + xScale(d['x']) + ',' + yScale(d['y']) + ') rotate(10 0 0)';
                    }
                    else if (d['slug'] == 'jefferson') {
                        return 'translate(' + xScale(d['x']) + ',' + yScale(d['y']) + ') rotate(-68 0 0)';
                    }
    ...
    d3.select('.scale-bar')
        ...
        .text(scaleBarDistance.toFixed(1) + ' miles');
}
