...
var LABEL_ADJUSTMENTS = {
    'Home healthcare users, National': {
        'text': {
            'dy': -0
        }
    },
    'Home healthcare users, Missouri': {
        'text': {
            'dy': 0
        }
    },
    'Skilled nursing facility users, National': {
        'text': {
            'dy': 12
        }
    },
    'Skilled nursing facility users, Missouri': {
        'text': {
            'dy': -12
        }
    },
...
var renderLineChart = function(config) {
    ...
    var colorScale = d3.scale.ordinal()
        ...
        .range([colors.ltgreen,colors.dkgreen,colors.yellow,colors.orange]);
    ...
    chartElement.append('g')
        ...
        .enter().append('text')
            ...
            .attr('dx', function(d) {
                return positionLabel(LABEL_ADJUSTMENTS, d['name'], 'text', 'dx');
            })
            .attr('dy', function(d) {
                return positionLabel(LABEL_ADJUSTMENTS, d['name'], 'text', 'dy');
            })
