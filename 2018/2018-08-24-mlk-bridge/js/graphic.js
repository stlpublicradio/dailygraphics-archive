    ...
    d3.select('.scale-bar')
        ...
        chartElement.append('g')
                ...
                .enter().append('text')
                    ...
                    .attr('transform', function(d) {
                        if (d['slug'] == 'mississippi' || d['slug'] == 'arch') {
                            return 'translate(' + xScale(d['x']) + ',' + yScale(d['y']) + ') rotate(-74 0 0)';
                        }
