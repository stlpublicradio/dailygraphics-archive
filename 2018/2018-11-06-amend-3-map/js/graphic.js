...
var renderGraphic = function (config) {
    ...
    d3.json("mocountieskc.json", function (error, geodata) {
        ...
        var color = d3.scale.linear()
            ...
            .range([d3.rgb(colors.purple), d3.rgb("#fff"), d3.rgb(colors.orange)])
        ...
        var MakeText = function (row) {
            ...
            updateSelection
                ...
                .html(function (d) {
                    return d["value"]["candidates"] + ": <span class='pct'>" + fmtPct(d["value"]["pct"]) + "</span> <span class='votes'>(" + fmtComma(d["value"]["total"]) + ")</span>";
                })
        ...
        distribution.selectAll("line")
            ...
            .attr("stroke", function (d) {
                ...
                return d.properties.r_lead > 0 ? colors.orange : colors.purple
                // return color(d.properties.r_lead * 100)
            })
