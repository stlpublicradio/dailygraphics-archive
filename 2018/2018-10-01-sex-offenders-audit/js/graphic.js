...
function render(width) {
		...
		var northEast = L.latLng(42.1136, -87.5988),
		    southWest = L.latLng(34.4957, -97.2741),
	    ...
	    var svg = d3.select(map.getPanes().overlayPane).append("svg"),
			...
			// update filename, collection name
			 ...
			 d3.json("sex_offenders_audit.topojson", function(error, geodata) {
				 
				 var regions = topojson.feature(geodata, geodata.objects.sex_offenders_audit);
				 var geojson;
			 ...
			 return d < 5 ? '#ffffff' :
				 ...
				 function style(feature) {
						 return {
							 // update property
					         fillColor: getColor(feature.properties.noncom_pct),
					         weight: 1,
					         opacity: 1,
					         color: '#fff',
					        //  dashArray: '3',
				 ...
				 info.update = function (props) {
					 ...
					 // example ternary logic for infobox
					   (
						 props ?
						'<strong>' + (props.name == 'St. Louis city' ? props.name : props.name + ' County') + '</strong> had ' + props.offenders + ' sex offenders. ' + props.noncomplia + ', or ' + props.noncom_pct + '%, were noncompliant.'
						 : 'Hover over a county');
				 };
				 ...
				 legend.onAdd = function (map) {
					 ...
					 text = ['< 5%','5-9%','10-14%','15-19%','20-24%','>25%']
					 labels = [];
