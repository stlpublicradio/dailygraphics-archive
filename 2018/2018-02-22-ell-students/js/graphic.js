...
var renderLineChart = function(config) {
    ...
    var colorScale = d3.scale.ordinal()
        ...
        .range([colors.red,colors.ltblue,colors.blue,colors.dkblue,colors.green,colors.dkgreen,colors.orange,colors.yellow]);
    ...
    chartElement.append('g')
        ...
        .enter().append('text')
            ...
            .attr('dy', function(d) {
                return positionLabel(LABEL_ADJUSTMENTS, d['name'], 'dy');
            })
            .text(function(d) {
                return d['name'];
            })
