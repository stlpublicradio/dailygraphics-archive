...
var renderLocatorMap = function (config) {
    ...
    chartElement.append('g')
        ...
        .data(mapData['countries']['features'])
        .enter().append('text')
        .filter(function(d) {console.log(d); return d['properties']['county'] == 'St. Louis city'})
        ...
        .text(function (d) {
            return COUNTRIES[d['properties']['county']] || d['properties']['county'];
        })
        .call(wrapText,50,14);
