...
var renderGroupedBarChart = function(config) {
    ...
    var yScale = d3.scale.linear()
        ...
        var c=d3.rgb(colors.dkblue);
        var c1=c.brighter(0.4);
        var c2=c1.brighter(0.4);
        var c3=c2.brighter(0.4);
        var c4=c3.brighter(0.4);
    ...
    chartWrapper.append('ul')
        ...
        .append('li')
            .attr('style', function(d,i) {
                var top = ((groupHeight + barGap) * i) + (groupHeight * .40);
    ...
    barGroups.append('g')
        ...
        .append('text')
            ...
            .attr('y', function(d, i) {
                ...
                return (barHeight * i) + barGapInner + (i*2);
            })
            .attr('dx', function(d) {
