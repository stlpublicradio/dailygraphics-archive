...
function render(width) {
		...
		var map = L.map('map', {scrollWheelZoom: false, attribution: '', minZoom: 14, maxZoom: 16}).setView([38.648467,-90.210173], 15).setMaxBounds(bounds);
	    ...
	    var svg = d3.select(map.getPanes().overlayPane).append("svg"),
			...
			// update filename, collection name
			 ...
			 d3.json("2016-06-02-nga-city.topojson", function(error, geodata) {
