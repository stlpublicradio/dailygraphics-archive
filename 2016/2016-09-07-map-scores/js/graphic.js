...
var formatData = function() {
    GL_MATH.forEach(function(d) {
        d['amt'] = +d['amt'];
    });

    GL_ENGLISH.forEach(function(d) {
        d['amt'] = +d['amt'];
    });

    SUBGROUP_MATH.forEach(function(d) {
        d['amt'] = +d['amt'];
    });

    SUBGROUP_ENGLISH.forEach(function(d) {
        d['amt'] = +d['amt'];
    });
...
var render = function(containerWidth) {
    ...
    renderColumnChart({
        container: '#column-chart2',
        width: containerWidth,
        data: GL_ENGLISH
    });

    renderColumnChart({
        container: '#column-chart3',
        width: containerWidth,
        data: SUBGROUP_MATH
    });

    renderColumnChart({
        container: '#column-chart4',
        width: containerWidth,
        data: SUBGROUP_ENGLISH
    });
