...
var renderSlopegraph = function(config) {
    ...
    var colorScale = d3.scale.ordinal()
        ...
        .range([ colors.gray,colors.yellow,colors.gray ]);
    ...
    chartElement.append('g')
        ...
        .append('text')
            ...
            .text(function(d) {
                if (isSidebar) {
                    return fmtComma(d[startColumn].toFixed(0)) + 'M';
                }

                return fmtComma(d[startColumn].toFixed(1)) + 'M';
            });
    ...
    chartElement.append('g')
        ...
        .append('text')
            ...
            .text(function(d) {
                if (isSidebar) {
                    return fmtComma(d[endColumn].toFixed(0)) + 'M';
                }

                return fmtComma(d[endColumn].toFixed(1)) + 'M';
            });
